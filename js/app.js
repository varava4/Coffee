(() => {
    ...
    function initSliders() {
        if (document.querySelector(".blend__slider")) new swiper_core_Swiper(".blend__slider", {
        ...
        if (document.querySelector(".feedback__slider")) {
            const bigSlider = new swiper_core_Swiper(".feedback__slider", {
            ...
            const smallSider = new swiper_core_Swiper(".foto-feedback__slider", {
            ...
            smallSider.controller.control = bigSlider;
            bigSlider.controller.control = smallSider;
        }
    }
